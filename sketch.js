...
function setup() {
	...
	mango1=new Mango(760,290,34);
	mango2=new Mango(995,325,35);
	mango3=new Mango(820,260,35);
	mango4=new Mango(890,200,35);
	mango5=new Mango(890,320,36);
	mango6=new Mango(950,250,35);
	mango7=new Mango(965,170,33);
	mango8=new Mango(1060,260,35);
	mango9=new Mango(1090,220,35);
	mango10=new Mango(2000,305,35);

	attach=new Throw(stones.body,{x:100,y:465});

	tree=createSprite(900,368);
	tree.addImage(treeimg);
	tree.scale=0.42;

	boy=createSprite(220,550);
	boy.addImage(boyimg);
	boy.scale=0.125;
